...
Finally, I apply these insights specifically to accounting, where concerns
about publication dysfunction are acute but systematic analysis of peer review
mechanics is absent.
...
I do not model researcher behavior directly---the simulation calculates
acceptance probabilities, not equilibrium strategies. However, the incentive
structure implied by these probabilities is consistent with
cite:azoulayDoesPeerReview2025, who provide evidence that peer review penalizes
researchers who pursue bold, unconventional work. If innovative research faces
higher variance in reviewer assessments (less consensus on what "good" looks
like), the AND-gate effect would be amplified, making conservative, incremental
work relatively more attractive in expected value terms.
