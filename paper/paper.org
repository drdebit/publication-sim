...
strong on one dimension but weak on another. My independence assumption is thus
conservative---it produces higher false rejection rates than would obtain under
